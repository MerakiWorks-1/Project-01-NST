        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {successStories.map((story) => (
              <Card key={story.name} className="group hover:shadow-glow transition-all duration-300">
                <div className="relative">
                  <img
                    src={story.image}
                    alt={story.name}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={tier.tier} className={`relative ${tier.popular ? 'border-primary shadow-glow' : ''}`}>
                {tier.popular && (
